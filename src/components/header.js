      ...
      <AppBar position="fixed" >
        <Toolbar className={classes.headerSpace}>
          ...
          <div className={classes.sectionDesktop}>
              ...
              className={props.state.home?classes.navTitleActive: classes.navTitle}
              ...
              <IconButton edge="start"
                aria-label="account of current user"
                className={props.state.initiative?classes.navTitleActive: classes.navTitle}
                aria-haspopup="true"
              ...
              <IconButton edge="start"
           className={props.state.whoCanJoin?classes.navTitleActive: classes.navTitle}
                aria-label="account of current user"
              ...
              <IconButton edge="start"
            className={props.state.whatCanYouDo?classes.navTitleActive: classes.navTitle}
                aria-label="account of current user"
              ...
              <IconButton edge="start"
                aria-label="account of current user"
                className={props.state.contact?classes.navTitleActive: classes.navTitle}
                aria-haspopup="true"
