...
const Contact = () => {
    return (
                ...
                <div className="row">
                    ...
                    <div className="col-md-6" id="contact1">
                        ...
                        <Button
                                variant="contained"
                                color="secondary"
                                style={{color:'#42AC73',backgroundColor:'#C0E3D0',}}
                                onClick={()=>window.open('https://github.com/adminiitbact','target')}
      ...
      <Button
                            ...
                            // className={classes.button}
                            onClick={()=>window.open('https://github.com/adminiitbact/iitbact.org','target')}
                            ...
                            <Button
                                variant="contained"
                                color="secondary"
                                style={{color:'#2497D1',backgroundColor:'#EDEEEF'}}
                            // className={classes.button}
                            startIcon={<WhatsAppIcon />}
                            onClick={()=>window.open('https://api.whatsapp.com/send?phone=919810089232','target')}
                            >
                                JOIN US ON WHATSAPP
      </Button>
                        </div>
