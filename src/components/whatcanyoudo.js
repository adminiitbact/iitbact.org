  ...
  return (
    <div id="whatCanYouDo">
      <div className="container sectionContainer">
        ...
        <p className="sectionPara" style={{margin:'30px 40px'}}>
          ...
          our number one priority.<br></br>
          <br></br> You think you don’t have anything to offer? We disagree!
          <br></br>
          This war against the invisible enemy is all hands on deck, and rest
          assured we will help you find your place.
        </p>
      </div>
    </div>
  );
